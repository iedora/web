...
[`infra/cmd/menu-db-migrations/lint.go`](../infra/cmd/menu-db-migrations/lint.go)
...
[`lint_test.go`](../infra/cmd/menu-db-migrations/lint_test.go).
...
Implemented in
[`infra/cmd/iedora/runtime_docker.go::dockerOnHetzner.deployHotSwap`](../infra/cmd/iedora/runtime_docker.go),
opted in by the `Healthcheck` field on the menu product literal in
[`products.go`](../infra/cmd/iedora/products.go). Tested via
[`runtime_docker_swap_test.go`](../infra/cmd/iedora/runtime_docker_swap_test.go)
...
[`infra/cmd/local/`](../infra/cmd/local/) is a thin Go shim that:
...
4. Runs `bin/zitadel-apply --mode local --output-file
   infra/local/.zitadel-bootstrap/outputs.json` against
